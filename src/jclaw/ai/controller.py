    ...
    def _decide_next_tool_step(
        ...
        *,
        ...
        prompt = (
            ...
            "For coding tasks, inspect before editing, prefer structural navigation when a function or class is identifiable, and prefer narrow edits over whole-file rewrites.\n"
            "After a code edit, prefer a verification step such as a relevant run_command before answer or complete when a meaningful local check is known.\n"
            "Before complete on a coding task, prefer to inspect the latest diff and ensure your answer states what was verified or not verified.\n"
            "If the latest verification step failed and a plausible repair step exists, prefer another tool_call instead of answer or complete.\n"
